...
# User
def create_user_with_array(id, username, first_name, last_name, email, password, phone, user_status, id_2, username_2, first_name_2, last_name_2, email_2, password_2, phone_2, user_status_2):
    """
...
def create_user_with_list(id, username, first_name, last_name, email, password, phone, user_status, id_2, username_2, first_name_2, last_name_2, email_2, password_2, phone_2, user_status_2):
    """
...
def delete_user_by_username(username):
    ...
    """
    url = f"user/{username}"
    payload = {"id": 12442343244, "username": "poke_user2", "firstName": "pikachu2", "lastName": "pokemon2", "email": "pokemon2@test.com", "password": "Wafsoheruh43@", "phone": "+1247862984723", "userStatus": 0}
